...
| [<img src="https://rmux.io/demos/demo-orchestration.png" width="150" alt="マルチエージェント編成デモのプレビュー">](https://rmux.io/#demo-orchestration)<br><sub>マルチエージェント編成</sub><br><sub>≃ 514 lines</sub> | [<img src="https://rmux.io/demos/demo-broadcast.png" width="150" alt="Agent Broadcast Arena デモのプレビュー">](https://rmux.io/#demo-broadcast)<br><sub>Agent Broadcast Arena</sub><br><sub>≃ 2,171 lines</sub> | [<img src="https://rmux.io/demos/demo-zellij.png" width="150" alt="Mini-Zellij デモのプレビュー">](https://rmux.io/#demo-zellij)<br><sub>Mini-Zellij</sub><br><sub>≃ 944 lines</sub> | [<img src="https://rmux.io/demos/demo-mirroring.png" width="150" alt="ターミナルとブラウザのミラーリングデモのプレビュー">](https://rmux.io/#demo-mirroring)<br><sub>ターミナル &lt;&gt; ブラウザミラーリング</sub><br><sub>≃ 649 lines</sub> | [<img src="https://rmux.io/demos/demo-playwright.png" width="150" alt="Playwright テストデモのプレビュー">](https://rmux.io/#demo-playwright)<br><sub>Playwright テスト</sub><br><sub>≃ 1,495 lines</sub> |
| --- | --- | --- | --- | --- |
