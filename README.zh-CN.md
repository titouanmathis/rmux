...
| [<img src="https://rmux.io/demos/demo-orchestration.png" width="150" alt="多智能体编排演示预览">](https://rmux.io/#demo-orchestration)<br><sub>多智能体编排</sub><br><sub>≃ 514 lines</sub> | [<img src="https://rmux.io/demos/demo-broadcast.png" width="150" alt="Agent Broadcast Arena 演示预览">](https://rmux.io/#demo-broadcast)<br><sub>Agent Broadcast Arena</sub><br><sub>≃ 2,171 lines</sub> | [<img src="https://rmux.io/demos/demo-zellij.png" width="150" alt="Mini-Zellij 演示预览">](https://rmux.io/#demo-zellij)<br><sub>Mini-Zellij</sub><br><sub>≃ 944 lines</sub> | [<img src="https://rmux.io/demos/demo-mirroring.png" width="150" alt="终端浏览器镜像演示预览">](https://rmux.io/#demo-mirroring)<br><sub>终端 &lt;&gt; 浏览器镜像</sub><br><sub>≃ 649 lines</sub> | [<img src="https://rmux.io/demos/demo-playwright.png" width="150" alt="Playwright 测试演示预览">](https://rmux.io/#demo-playwright)<br><sub>Playwright 测试</sub><br><sub>≃ 1,495 lines</sub> |
| --- | --- | --- | --- | --- |
